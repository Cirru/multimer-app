...
(task-options!
  pom {:project     'cirru/multimer-app
       :version     +version+
       :description "Workflow"
       :url         "https://github.com/Cirru/multimer-app"
       :scm         {:url "https://github.com/Cirru/multimer-app"}
...
(deftask dev []
  (comp
    ...
    (watch)
    (reload :on-jsload 'multimer-app.core/on-jsload)
    (cljs)
    (target)))
